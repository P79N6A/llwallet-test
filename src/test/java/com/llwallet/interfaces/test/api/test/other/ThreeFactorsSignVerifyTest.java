...
public class ThreeFactorsSignVerifyTest {
	...
	public void threeFactorsSignVerify(Map<String, String> datadriven) throws Exception {
		...
		String threeFactorsSignVerifyUrl = Property.get("llwallet.threeFactorsSignVerify.url");
	...
	public Iterator<Object[]> data4threeFactorsSignVerify() throws IOException {
		return new ExcelProvider(this, "threeFactorsSignVerify",3);
	}
