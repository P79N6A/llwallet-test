...
public class QueryVbAccountOnlineTest {
	...
	public void queryVbAccount(Map<String, String> datadriven) throws Exception {
		...
		String queryVbAccountUrl = Property.get("llwallet.queryVbAccount.url.online");
	...
	public Iterator<Object[]> data4queryVbAccount() throws IOException {
		return new ExcelProvider(this, "queryVbAccount",2);
	}
