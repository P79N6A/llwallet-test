...
public class UserBusiQueryTest {
	...
	public void userBusiQuery(Map<String, String> datadriven) throws Exception {
		...
		if (!datadriven.get("result_code").contains("\"ret_code\":\"0000\",\"ret_msg\":\"交易成功\"")){
			DbUtils dbUtils = new DbUtils();
			dbUtils.updateUserBusiCtl(datadriven.get("user_id"));
		}
		...
		String userBusiQueryUrl = Property.get("llwallet.userBusiQuery.url");
