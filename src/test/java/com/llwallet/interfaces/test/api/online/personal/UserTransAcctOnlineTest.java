...
public class UserTransAcctOnlineTest {
	...
	public void userTransAcct(Map<String, String> datadriven) throws Exception {
		...
		String userTransAcctUrl = Property.get("llwallet.userTransAcct.url.online");
	...
	public Iterator<Object[]> data4userTransAcct() throws IOException {
		return new ExcelProvider(this, "userTransAcct",2);
	}
