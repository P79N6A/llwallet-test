...
//		assert hf.getResponseBody().contains(datadriven.get("result_stat_user"));
//		assert hf.getResponseBody().contains(datadriven.get("result_kyc_status"));
//		assert hf.getResponseBody().contains(datadriven.get("result_exp_idcard"));
	...
	public Iterator<Object[]> data4singleUserQuery() throws IOException {
		return new ExcelProvider(this, "singleUserQuery",11);
	}
