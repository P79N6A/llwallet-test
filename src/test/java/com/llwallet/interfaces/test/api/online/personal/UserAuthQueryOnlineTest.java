...
public class UserAuthQueryOnlineTest {
	...
	public void userAuthQuery(Map<String, String> datadriven) throws Exception {
		...
		String userAuthQueryUrl = Property.get("llwallet.userAuthQuery.url.online");
	...
	public Iterator<Object[]> data4userAuthQuery() throws IOException {
		return new ExcelProvider(this, "userAuthQuery",4);
	}
