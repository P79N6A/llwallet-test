...
public class ThreeFactorsPayVerifyOnlineTest {
	...
	public void threeFactorsPayVerify(Map<String, String> datadriven) throws Exception {
		...
		String threeFactorsPayVerifyUrl = Property.get("llwallet.threeFactorsPayVerify.url.online");
	...
	public Iterator<Object[]> data4threeFactorsPayVerify() throws IOException {
		return new ExcelProvider(this, "threeFactorsPayVerify",4);
	}
