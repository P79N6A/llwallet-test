...
public class UnitCashoutNowApplyOnlineTest {
	...
	public void unitCashoutNowApply(Map<String, String> datadriven) throws Exception {
		...
		String unitCashoutUrl = Property.get("llwallet.unitCashoutNowApply.url.online");
	...
	public Iterator<Object[]> data4unitCashoutNowApply() throws IOException {
		return new ExcelProvider(this, "unitCashoutNowApply",1);
	}
