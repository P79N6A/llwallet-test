...
public class ThreeFactorsSignApplyOnlineTest {
	...
	public void threeFactorsSignApply(Map<String, String> datadriven) throws Exception {
		...
		String threeFactorsSignApplyUrl = Property.get("llwallet.threeFactorsSignApply.url.online");
	...
	public Iterator<Object[]> data4threeFactorsSignApply() throws IOException {
		return new ExcelProvider(this, "threeFactorsSignApply",2);
	}
