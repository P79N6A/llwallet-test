...
public class RevokeTest {
	...
	@Test(description = "撤销测试", timeOut = 60000, dataProvider = "provider")
	public void test(LinkedHashMap<String, LinkedHashMap<String, String>> dt, ExcelProvider2 excel) throws Exception {
		...
		revokeJson.put("originalOutTradeNo", no_orderConsumer);// 原消费流水外部单号
	    //revokeJson.put("originalOutTradeNo", "ConsumerBill20180125133944");//原单已撤销成功，重复撤销
	    //revokeJson.put("originalOutTradeNo", "ConsumerBill20180125134932");//原单为撤销处理中，重复撤销
	    //revokeJson.put("originalOutTradeNo", "ConsumerBill20180125140340");//原单为撤销失败，重复撤销
	    //revokeJson.put("originalOutTradeNo", "ConsumerBill20180125144744");//原单为撤销失败，重复撤销
		...
		Reporter.log("撤销测试： " + dt.get("createQr").get("comment"), true);
		System.out.println("===============================================");

		// 请求&响应写入文件
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", MyDate.getStringDate());
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", reqJson);
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", rsp);
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", json.toString());
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", rsp1);
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", revokeJson.toString());
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", rsp2);
		SampleFileUtils.appendLine("D://TA//log//revoke.txt", "===============================================");
