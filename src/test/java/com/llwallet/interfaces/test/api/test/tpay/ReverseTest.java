...
public class ReverseTest {
	...
	@Test(description = "消费冲正测试", timeOut = 60000, dataProvider = "provider")
	public void test(LinkedHashMap<String, LinkedHashMap<String, String>> dt, ExcelProvider2 excel) throws Exception {
		...
		reverseJson.put("originalOutTradeNo", no_orderConsumer);// 原消费流水外部单号
		...
		String rsp2 = HttpRequest.httpPostWithJSON(reverseUrl, reverseJson.toString());

		Reporter.log("消费冲正测试： " + dt.get("createQr").get("comment"), true);
		System.out.println("===============================================");

		// 请求&响应写入文件
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", MyDate.getStringDate());
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", reqJson);
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", rsp);
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", json.toString());
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", rsp1);
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", reverseJson.toString());
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", rsp2);
		SampleFileUtils.appendLine("D://TA//log//reverse.txt", "===============================================");
